# Descarga Cuentas Tributarias AFIP

Bot de descarga de Cuentas Tributarias de AFIP
...
4. Descargar el BOT. Acá hay 3 opciones:
   ...
   3. Descargar el repositorio con GIT utilizando el comando `git clone https://github.com/abustosp/Descarga-de-Cuentas-Tributarias.git`
...
- En caso que no se guarden los Archivos con el nombre definido en el Excel se debe cambiar el valor de la columna ST a "NO"
